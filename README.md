...
![Updated](https://img.shields.io/badge/updated-2026.06.14-000?style=flat-square)
...
| --------------------------------------------------------------------------------------------- | ----: | -----: | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------- |
| [academic-research-skills](https://github.com/Imbad0202/academic-research-skills)             | 31.2k |      — | A human-in-the-loop pipeline built to fight AI fabrication that deliberately refuses to ghost-write; non-commercial license                                                                                                                              | `net` `hooks` |
...
| [anthropics/life-sciences](https://github.com/anthropics/life-sciences)                       |   455 |      — | Anthropic's official life-sciences marketplace — a vetted directory of ~20 partner data integrations, not a skill collection                                                                                                                             | `net`         |
| [aut_sci_write](https://github.com/shzhao27208/aut_sci_write)                                 |   120 |      — | Modular research-lifecycle suite: literature search across arXiv/PubMed/Web of Science, PDF and figure extraction, review/meta-analysis writing, Zotero sync and slides. Broad and well-adopted; a do-everything suite, not a best-in-one-stage tool     | `net`         |
...
| [nature-skills](https://github.com/Yuan1z0825/nature-skills)                                  | 19.7k |      9 | A tight 9-skill bundle strongest on Nature-style prose and figures, weakest as a data toolkit                                                                                                                                                            | `net`         |
...
| [papercash](https://github.com/jesseovo/papercash)                                            |    73 |      — | End-to-end Chinese-student paper workflow over 8 free sources (S2, arXiv, Crossref, PubMed, CNKI, Wanfang, Baidu/Google Scholar): search, review, polish, plagiarism precheck, AI-rate reduction, GB/T-7714 refs. Broad but shallow per stage            | `net` `hooks` |
| [posit-dev/skills](https://github.com/posit-dev/skills)                                       |   397 |      — | Posit's official R / Quarto / tidyverse skills from the makers of RStudio — the pick when analysis lives in R, not Python                                                                                                                                | —             |
...
| [scholaraio](https://github.com/zimoliao/scholaraio)                                          |   518 |      — | Modular all-in-one research suite (47 skills): literature search, reference management, PDF parsing and writing support, built to compose. A reasonable general backbone of moderate depth; note it ships an SSH-backup feature and a hook to review     | `net` `hooks` |
...
| [xueshuzhi-skills](https://github.com/yipng05-max/-skills)                                    |   213 |      — | Wide-coverage Chinese academic suite: topic selection, research design, CNKI/foreign literature search and verification, thematic coding, review and dissertation drafting, plus a 12-checkpoint TA pipeline assembling a Word draft. Breadth over depth | `net`         |
...
**academic-research-skills-codex**, **bioSkills**, **clawbio**, **encode-toolkit**, **medsci-skills**. (Links and descriptions are in the lifecycle sections above.)
