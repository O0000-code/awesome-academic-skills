...
![Updated](https://img.shields.io/badge/updated-2026.06.19-000?style=flat-square)
...
| --------------------------------------------------------------------------------------------- | ----: | -----: | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------- |
| [academic-research-skills](https://github.com/Imbad0202/academic-research-skills)             | 32.8k |      — | A human-in-the-loop pipeline built to fight AI fabrication that deliberately refuses to ghost-write; non-commercial license                                                                                                                              | `net` `hooks` |
| [academic-research-skills-codex](https://github.com/imbad0202/academic-research-skills-codex) |  4.2k |      — | Codex-native Academic Research Skills: deep research, paper drafting, manuscript review, research-to-paper pipelines, citation/integrity checks. Broad end-to-end; vendored as one giant skill (audit accordingly); non-commercial license               | `net` `hooks` |
...
| [anthropics/life-sciences](https://github.com/anthropics/life-sciences)                       |   464 |      — | Anthropic's official life-sciences marketplace — a vetted directory of ~20 partner data integrations, not a skill collection                                                                                                                             | `net`         |
...
| [claude-research](https://github.com/flonat/claude-research)                                  |    92 |      — | PhD-researcher infrastructure: 50 skills plus agents, hooks and rules for bibliography validation, LaTeX health-checks, experiment and causal design, and reproducible project setup. Strong end-to-end; ships hooks and an unscoped Bash                | `net` `hooks` |
...
| [codex-paper-skills](https://github.com/moonlarry/codex-paper-skills)                         |    88 |      — | Codex/Claude paper suite (27 skills) covering the writing chain, figures, experiment-to-claim consistency, citation auditing, proof checking and rebuttal, with an evidence-first agent protocol. Strong breadth; the missing LICENSE is its main gap    | `net`         |
| [google-deepmind/science-skills](https://github.com/google-deepmind/science-skills)           |  1.9k |     37 | Google DeepMind's official pack grounding agents in real biological data — narrow to structural bio and genomics, but authoritative                                                                                                                      | `net`         |
...
| [nature-skills](https://github.com/Yuan1z0825/nature-skills)                                  | 21.2k |      9 | A tight 9-skill bundle strongest on Nature-style prose and figures, weakest as a data toolkit                                                                                                                                                            | `net`         |
...
| [scientific-agent-skills](https://github.com/K-Dense-AI/scientific-agent-skills)              | 28.7k |    142 | The biggest computational-science pack — deep for life-science labs, near-useless for humanities                                                                                                                                                         | `net`         |
| [scientific-research-skills](https://github.com/jxtse/scientific-research-skills)             |    47 |      — | Methodology-first research skills for agents: literature search, three-depth paper reading, full-text harvest, related-work survey, Zotero management and publication-figure generation                                                                  | `net`         |
| [voidful/academic-skills](https://github.com/voidful/academic-skills)                         |    91 |      8 | A compact, opinionated grad-school pipeline (CS/ML flavor) across Claude Code, Codex and Gemini                                                                                                                                                          | —             |
| [xueshuzhi-skills](https://github.com/yipng05-max/-skills)                                    |   220 |      — | Wide-coverage Chinese academic suite: topic selection, research design, CNKI/foreign literature search and verification, thematic coding, review and dissertation drafting, plus a 12-checkpoint TA pipeline assembling a Word draft. Breadth over depth | `net`         |
...
**AcademicForge**, **arxiv-skills**, **clawbio**, **humanizer-academic**, **latex-document-skill**. (Links and descriptions are in the lifecycle sections above.)
